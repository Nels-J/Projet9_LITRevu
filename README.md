...
1. Accédez à l'interface via votre navigateur à l'adresse : `http://127.0.0.1:8000/`
2. Connectez-vous avec le `superuser` que vous avez créé précédemment.
3. Vous pouvez maintenant créer des tickets, rédiger des critiques et suivre d'autres utilisateurs.
4. Pour vous déconnecter, cliquez sur le bouton `Se déconnecter` dans le menu de navigation.
...
1. Rendez-vous sur la page `Abonnements` en cliquant sur le lien `Abonnements` du menu de navigation.
...
3. Cliquez sur le bouton `Envoyer` pour soumettre votre demande de critique.
...
1. Depuis la page `Flux` ou `Posts`
